...
#define EXHAUST_BANNER "tube, starting exhaust."
...
static void print_menu(void)
{
  fprintf(stderr,
    "\r\ntube menu:\r\n"
    "h, ? : this help\r\n"
    "i, > : inject tube tubencoded binary (%s)\r\n"
...
static int inject_binary(int ptmfd)
{
  ...
  if (0 != write_all(ptmfd, "begin 755 tube\n", 19)) {
err:
    close(fd);
    return -1;
  }
...
int main(int num_args, char const **args)
{
  ...
  {
    char const str[] =
      "Don't Stop me now, Let me shout off my troubles...\n"
      "Don't Notice me please, Let me cry out my heart...\n"
      "Don't let me Fail, As and when I try...\n"
      "Don't make me bother, Of the words I lie...\n"
      "Let not my dreams go to Dawn, Don't point me out from the crowd I tie...\n"
      "Such Unlamented I wish to Live ...Such Unlamented I want to Die  !!!\n";
